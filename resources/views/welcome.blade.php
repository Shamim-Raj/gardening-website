<x-guest-layout>
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">আপনার বাড়িটিকে বাগানের মতো করুন</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    <h1 class="display-1 text-white mb-5 animated slideInDown">আপনার বাড়িতে ও ছাদে  নিজের ছোট বাগান তৈরি করুন</h1>
                                    <a href="" class="btn btn-primary py-sm-3 px-sm-4">Explore More</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 col-md-7 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h1 class="display-5 mb-4">আমরা আপনার বাড়িকে বাগানের মতো করে তুলি</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="fs-5 fw-bold text-primary">কেন আমাদের নির্বাচন করে!</p>
                    <h1 class="display-5 mb-4">লোকেরা কেন আমাদের বেছে নেয় তার কয়েকটি কারণ!</h1>
                    <p class="mb-4">Tempor erat elitr rebum at clita. Diam dolor diam ipsum sit. Aliqu diam amet diam et eos. Clita erat ipsum et lorem et sit, sed stet lorem sit clita duo justo magna dolore erat amet</p>
                    <a class="btn btn-primary py-3 px-4" href="">Explore More</a>
                </div>
                <div class="col-lg-6">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">আমাদের সেবা</p>
                <h1 class="display-5 mb-5"> আপনার জন্য যে পরিষেবা অফার আমরা দিচ্ছি </h1>
            </div>
            <div class="row g-4">
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">আমাদের প্রকল্প</p>
                <h1 class="display-5 mb-5">আমাদের কিছু চমৎকার প্রকল্প</h1>
            </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="fs-5 fw-bold text-primary">আমাদের সদস্য</p>
                <h1 class="display-5 mb-5">নিবেদিত এবং অভিজ্ঞ দলের সদস্য</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="fs-5 fw-bold text-primary">প্রশংসা লিপি</p>
                    <h1 class="display-5 mb-5">আমাদের ক্লায়েন্টরা আমাদের সম্পর্কে কী বলে!</h1>
                    ...
                    <a class="btn btn-primary py-3 px-4" href="">আরো পড়ুন</a>
                </div>
